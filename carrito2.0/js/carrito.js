...
function actualizarDespacho() {
    ...
    if (totalCalculado < 10000) {
     return   despacho.innerText = `$${totalCalculado*0.05}`
    
    } else if (totalCalculado => 10000)
     return   despacho.innerText = `0`;
    ...
    function totalProducto (){
       ...
       total.innerText = `$${precioProducto + precioIva + +precioDespacho}`
